...
import lchj.italkers.fragment.ActiveFragment;
import lchj.italkers.fragment.ContactFragment;
import lchj.italkers.fragment.GroupFragment;
import lchj.italkers.fragment.MyFragment;
import lchj.italkers.helper.BottomNavigationViewHelper;
import lchj.italkers.helper.NavHelper;
...
//        mPortrait.setup(Glide.with(this), Account.getUser());
    ...
    public void onTabChanged(NavHelper.Tab<Integer> newTab, NavHelper.Tab<Integer> oldTab) {
        ...
        if (Objects.equals(newTab.extra, R.string.action_home)||
                Objects.equals(newTab.extra, R.string.action_my)) {
            // 主界面时隐藏
